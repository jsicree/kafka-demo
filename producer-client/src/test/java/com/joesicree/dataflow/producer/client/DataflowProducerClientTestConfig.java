...
public class DataflowProducerClientTestConfig {
	...
	@Bean
    public ProducerClientFactory<TestMessage> clientFactory() {
		System.out.println("In clientFactory()");
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("topic", topicName);
		props.put("kafkaTemplate", kafkaTemplate());
		ProducerClientFactory<TestMessage> factory = new ProducerClientFactory<>(props);
        return factory;
    }
 
    @Bean
    public ProducerClient<TestMessage> dataflowProducerClient() throws Exception {
